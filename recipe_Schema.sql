...
-- -----------------------------------------------------
-- Table `cookingapplication`.`User`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cookingapplication`.`User` (
...
CREATE TABLE IF NOT EXISTS `cookingapplication`.`recipe` (
  ...
  CONSTRAINT `fk_recipe_User1`
    FOREIGN KEY (`User_id`)
    REFERENCES `cookingapplication`.`User` (`User_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
